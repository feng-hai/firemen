...
export default {
  ...
  methods: {
    ...
    initPage: function() {
      ...
      //that.width=500;
      //  console.log("jquery "+$("#layering").parent().outerWidth(true));
      //console.log(that.width);
      //  console.log(that.containerWidth);
      //that.width = 540;
      //初始化比例尺
      var width = $("#layering").parent().width();
      //if (that.width) {
      //  width = that.width;
      //}
      ...
      //初始化画布
      that.svg = d3.select("#layering").append("svg")
        .attr("width", width)
    ...
    openModel: function(d) {
      ...
      that.dataContent = d;
      //  console.log("数据："+$("#layering").parent().outerWidth(true));
      ...
      that.tipsOptions.top = (d.y * that.scale + that.translate[1] - 42 - 100 + 10) + "px";
      that.tipsOptions.left = (d.x * that.scale + that.translate[0] - 100 - RECT_W / 2) + "px";
